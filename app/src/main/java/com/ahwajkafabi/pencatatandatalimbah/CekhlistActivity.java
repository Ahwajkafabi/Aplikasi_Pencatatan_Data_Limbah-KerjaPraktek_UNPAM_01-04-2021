...
public class CekhlistActivity extends AppCompatActivity implements
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_new:
                Utils.sendCekhlistToActivity(this,null,CRUDActivity.class);
                return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cekhlist);
